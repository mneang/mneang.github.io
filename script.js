...
const translations = {
  en: {
    ...
    educationText: "BBA in Management Information Systems &amp; Operations Management &vert; Aug 2018 - Dec 2022",
  ...
  ja: {
    ...
    educationTitle: "学歴",
    educationText: "経営情報システム＆オペレーションマネジメント学士 &vert; 2018年8月～2022年12月",
  ...
  zh: {
    ...
    exp3Details: "2021年6月 - 8月 | Irvine, CA",
    educationTitle: "教育背景",
    educationText: "管理信息系统与运营管理学士 &vert; 2018年8月 - 2022年12月",
  ...
  ko: {
    ...
    educationTitle: "학력",
    educationText: "정보 시스템 및 운영 관리 전공 학사 &vert; 2018년 8월 – 2022년 12월",
